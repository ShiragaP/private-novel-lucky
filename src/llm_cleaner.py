...
2. ห้ามแปลงภาษาเด็ดขาด: ห้ามเปลี่ยนคำไทยเป็นภาษาอังกฤษ ห้ามแปลงเป็นอักษรโรมันหรือคาราโอเกะ และห้ามแปลเป็นภาษาอื่น
   - ข้อยกเว้นพิเศษ: หากพบคำผิดเพี้ยนที่เกิดจากระบบ AI รุ่นเก่าแปลงอักษรไทยเป็นโรมันตกค้างอยู่ในข้อความ (เช่น พบคำว่า 'ogon' หรือ 'ตะogon' ที่ควรเป็น 'ตะโกน') ให้แก้กลับคืนเป็นคำภาษาไทยที่ถูกต้องตามบริบทเดิม ('ตะโกน') เสมอ
